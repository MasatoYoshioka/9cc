...
assert 10 'main() { hoge=5; return hoge=10; }';
assert 3  'main() { hoge=3; return hoge; }'
assert 10 'main() { fuga=5; return fuga * 2; }'
assert 7  'main() { fuga=5; return fuga + 2; }'
assert 3  'main() { a=3; return a; }'
assert 8  'main() { a=3; z=5; return a+z; }'
assert 6  'main() { a=b=3; return a+b; }'
assert 2  'main() { 1; return 2; }'
...
assert 10 'main() { return 5 * (1 + 1); }'
assert 5  'main() { return 10 * 2 / 4; }'
assert 4  'main() { return 9 - 10 / 2; }'
assert 10 'main() { return 1 + 3 * 3; }'
assert 2  'main() { return 8 / 2 / 2; }'
assert 8  'main() { return 2 * 2 * 2; }'
assert 1  'main() { return 1 /1; }'
assert 4  'main() { return 8 / 2; }'
assert 49 'main() { return 7 * 7; }'
assert 3  'main() { return 1 + 1 + 1; }'
